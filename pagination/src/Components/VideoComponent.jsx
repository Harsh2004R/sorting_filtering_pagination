...
const VideoComponent = () => {
  ...
  return (
    ...
    <>
   <Box w="100%" h="auto" bg="#000000" pt="20px" pb="20px"><Text textAlign={"center"}  fontSize={{base:"xxl",md:"25px"}} color="#69F0AE" >Pagination with sorting and flitering</Text></Box> 
